...
class __TwigTemplate_5af114d953263843040973d07bd05a14 extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        // line 1
        yield "<footer class=\"bg-dark text-light py-4 fixed-bottom\">
    <div class=\"container\">
        <div class=\"row\">   
            <hr class=\"bg-light\">
        ...
        yield " Made By Musadaq (PROFESSOR)</p>
            </div>
        </div>
    </div>
</footer>
";
    ...
    {
        return new Source("<footer class=\"bg-dark text-light py-4 fixed-bottom\">
    <div class=\"container\">
        <div class=\"row\">   
            <hr class=\"bg-light\">
            <div class=\"text-center\">
                <p class=\"mb-0\">&copy; {{ 'now'|date('Y') }} Made By Musadaq (PROFESSOR)</p>
            </div>
        </div>
    </div>
</footer>
", "_partials/_footer.html.twig", "/home/mohamed-abshir/dev/CDA/Mon_Projet/avec Api+react/Vilage_Green/templates/_partials/_footer.html.twig");
    }
}
