...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('admin_products_app_produits_delete', {'id': product.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
